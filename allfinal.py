...
class TrafficDataAnalyzer:
    def __init__(self, base_path, output_dir_prefix="analysis"):
        self.base_path = base_path
        # Generate unique output directory name with timestamp
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        self.output_dir = os.path.join(base_path, f"{output_dir_prefix}_{timestamp}")
...
if __name__ == "__main__":
    try:
        ...
        analyzer = TrafficDataAnalyzer(base_path, output_dir_prefix="analysis")
